...
// rttmEval.smoothDirectory('RTTM-Human/1/');
// rttmEval.smoothDirectory('RTTM-Human/2/');
// rttmEval.smoothDirectory('RTTM-Human/3/');
...
// console.log('Run md-eval on 3.1');
// console.log(rttmEval.report('RTTM-Machine/LIUM-3.1'));
// console.log('Run md-eval on 4.2');
// console.log(rttmEval.report('RTTM-Machine/LIUM-4.2'));